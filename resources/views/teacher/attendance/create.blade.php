@extends('layouts.app')
@section('title', __('app.create_attendance'))
@section('page-title', __('app.create_attendance'))

@section('content')
<div class="card" style="max-width:640px;">
    <div class="card-header"><span class="card-title">{{ __('app.new') }} {{ __('app.session') }}</span></div>
    <div class="card-body">
        <form method="POST" action="{{ route('teacher.attendance.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" value="{{ old('title') }}" required placeholder="{{ __('app.session_title') }}...">
            ...
            <div class="form-group">
                ...
                <input type="text" name="password" value="{{ old('password') }}" placeholder="{{ __('app.no_password_required') }}">
            </div>
            <div class="flex gap-2">
                <button type="submit" class="btn btn-primary">{{ __('app.create_session') }}</button>
